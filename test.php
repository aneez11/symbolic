...
<nav class="navbar navbar-expand-lg navbar-light " style="border-bottom:1px solid grey;">
    <div class="container">
        <a class="navbar-brand" href="#"> <img src="assets/assets/images/logo.jpg" alt=""> </a>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="login-modal">
                    <div class="row h-100">
                        <div class="col-6 img-row" style="background-image: url('assets/assets/images/login_bg.jpg');">
                            <div class="row">
            ...
            <div class="modal-body">
                <div class="login-modal">
                    <div class="row h-100">
                        ...
                        <div class="col-6 img-row" style="background-image: url('assets/assets/images/signup.jpg');">
                            <div class="row">
